...
static iomux_v3_cfg_t MX6NAME(common_pads)[] = {
	...
	/* IPU - Touchscreen */
	MX6PAD(GPIO_9__GPIO_1_9),		/* AR1020 irq(J7) */
	...
	/* USB */
	NEW_PAD_CTRL(MX6Q_PAD_GPIO_17__GPIO_7_12, WEAK_PULLUP),		/*USB Hub reset */
	...
	NEW_PAD_CTRL(MX6Q_PAD_EIM_EB2__GPIO_2_30, WEAK_PULLUP),		/* PCIe wireless reset */
//	NEW_PAD_CTRL(MX6Q_PAD_SD3_RST__GPIO_7_8, WEAK_PULLUP),		/* PCIe reset */
	...
	NEW_PAD_CTRL(MX6PAD(SD3_DAT4__GPIO_7_1), WEAK_PULLUP),		/* spare */
	0
};
